...
Gleam scaffold under `stakeholder-circus`.
...
## Role
- Typed BEAM scaffold.
- Purpose: Typed BEAM parity lane with OTP-first execution and a later optional JavaScript compilation target.
- Program category: interop, research
